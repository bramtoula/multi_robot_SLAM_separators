...
int main(int argc, char **argv)
{
    ...
    keypointsToROS(kptsFrom, srv.request.kptsFrom);
    keypointsToROS(kptsTo, srv.request.kptsTo);

    descriptorsToROS(descriptorsFrom, srv.request.descriptorsFrom);
    descriptorsToROS(descriptorsTo, srv.request.descriptorsTo);
