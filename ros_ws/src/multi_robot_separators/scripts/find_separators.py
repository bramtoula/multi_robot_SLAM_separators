...
def find_separators():
    ...
    while not rospy.is_shutdown():
        ...
        # Compute descriptors
        rospy.logwarn("find : check 0")
        dataHandler.compute_descriptors()
        service_list = rosservice.get_service_list()
        rospy.logwarn("find : check 1")
